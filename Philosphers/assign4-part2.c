 ...
 * State 1 is thinking 
 * State 2 is eating
 * This will be used to check to see if the state of the philosphoers are in eating or not. If they are thinking then
 * the philosphers go to eating, after they pick up chopsticks. vise versa for eating. 
**/ 
#define EATING 0
#define THINKING 1
